...
inoremap <expr> <C-J> copilot#Accept("\<NL>")
inoremap <silent> <C-9> :tablast
inoremap <silent> <C-8> 8gt
inoremap <silent> <C-7> 7gt
inoremap <silent> <C-6> 6gt
inoremap <silent> <C-5> 5gt
inoremap <silent> <C-4> 4gt
inoremap <silent> <C-3> 3gt
inoremap <silent> <C-2> 2gt
inoremap <silent> <C-1> :tabfirst
inoremap <silent> <C-Del> <Right>dwi
inoremap <silent> <C-BS> <Right>dbi
...
nnoremap <silent> ,P "+P
nnoremap <silent> ,p "+p
nnoremap ,n :set number! number?
map <silent> ,== =      " Recalculate buffers size
map <silent> ,++ 100+   " Increase buffer height
map <silent> ,hw sl    " Horizontally
map <silent> ,vw vl    " Split vertically
...
nnoremap <silent> <C-1> :tabfirst
vnoremap <silent> <C-S> :wi
nnoremap <silent> <C-S> :wi
nnoremap <silent> <Home> g^
map <silent> <C-L> :tabnext
map <silent> <C-H> :tabprevious
...
inoremap <expr> <NL> copilot#Accept("\<NL>")
...
set runtimepath+=~/.vim/plugged/coc-json
set runtimepath+=~/.vim/plugged/coc-yaml
set runtimepath+=~/.vim/plugged/coc-prettier
set runtimepath+=~/.vim/plugged/coc-eslint
set runtimepath+=~/.vim/plugged/coc-snippets
set runtimepath+=~/.vim/plugged/coc-lists
...
set runtimepath+=~/.vim/plugged/gundo.vim
set runtimepath+=~/.vim/plugged/CamelCaseMotion
set runtimepath+=~/.vim/plugged/vim-indent-guides
set runtimepath+=~/.vim/plugged/vim-gitgutter
set runtimepath+=~/.vim/plugged/nyancat-vim
...
set runtimepath+=~/.vim/plugged/javascript-libraries-syntax.vim
...
set runtimepath+=/opt/homebrew/share/vim/vim91/pack/dist/opt/matchit
...
set runtimepath+=~/.vim/plugged/javascript-libraries-syntax.vim/after
